...
import styles from './ClientTable.module.css';
import * as XLSX from 'xlsx';
import SearchForm from '../SearchForm/ClientSearchForm';
    ...
    return (
        <div className={styles.main}>
            <div className={`${styles.tableContainer} ${styles.section}`}>
                ...
                />
                <div className={styles.buttonGroup}>
                    <button type="button" onClick={exportToExcel} className={styles.exportButton}>Export to Excel</button>
                </div>
            </div>
            ...
            <div className={`${styles.tableContainer} ${styles.section}`}>
                ...
                <DataTable<Client>
                    ...
                    columns={[
                        ...
                        { key: 'ic', label: 'IC Number', sortable: true },
                        { key: 'phone', label: 'Phone Number', sortable: true },
                        { key: 'roomNumber', label: 'Room Number', sortable: true },
                    ]}
                    sortColumn={sortColumn as keyof Client}
